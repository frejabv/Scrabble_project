...
//    let board      = ScrabbleUtil.InfiniteHoleBoard.infiniteHoleBoard ()
    ...
    let players = spawnMultiples "Adam" dictionary Adam.Scrabble.startGame 1
    //let players    = [("Adam#1", dictionary, Adam.Scrabble.startGame),("Adam#2", dictionary, Adam.Scrabble.startGame)]
